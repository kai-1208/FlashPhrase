...
2. **モードの選択**
   - **単語モード**: 英単語を見て日本語訳を答えるフラッシュカード形式の学習です。単語が表示された際に Web Speech API による自動音声読み上げが行われ、カード内に配置されたスピーカーボタンから何度でも発音を再再生することができます。
...
- **Icons**: Lucide React
- **Audio / Voice**: Web Speech API (Speech Synthesis)（英単語の自動読み上げおよび手動再生機能）
